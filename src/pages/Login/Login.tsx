      ...
      <div className='container flex items-center justify-center text-[#ffffff] font-euclid'>
        <div className='bg-black_night w-[435px] h-[510px] border rounded-[20px]'>
          <div className='pt-10 pl-16'>
            ...
            <div className='mb-6 font-bold text-xl'>Welcome to EventBook</div>
            <form>
              <div>
                <div className='flex flex-col font-euclid'>
                  <label className='pl-1 mb-2 font-bold hover:text-gray'>
                    Email
                  </label>
                  <input
              ...
              <button className='h-10 w-80 bg-[#ffff] text-[#000000] text-lg font-bold-700 rounded-[10px] hover:text-black_supper_light'>
                Sign in
              </button>
            </form>
          </div>
          <div className='my-10 h-[1px] bg-[#ffffff] bg-opacity-40' />
          <div className='flex items-center justify-center'>
            <button className='ml-3 h-10 w-80 bg-[#ffff] text-[#000000] text-lg font-bold-700 rounded-[10px] hover:text-black_supper_light'>
              Sign in
            </button>
          </div>
        </div>
